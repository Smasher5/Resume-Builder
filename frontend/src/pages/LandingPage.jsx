    ...
    <div className={landingPageStyles.container}>
        ...
        <header className={landingPageStyles.header}>
            <div className={landingPageStyles.headerContainer}>
                ...
                {/* Mobile menu button */}
                <button onClick={() => setmobileMenuOpen(!mobileMenuOpen)} className={landingPageStyles.mobileMenuButton}>
                    {mobileMenuOpen ? <X size={24} className={landingPageStyles.mobileMenuIcon}/> :
                    ...
                    <div className={landingPageStyles.heroLeft}>
                        ...
                        <div>
                            {[
                                ...
                                <div className={landingPageStyles.statsContainer} key={idx}>
                ...
                <div className={landingPageStyles.ctaContainer}>
                    <div className={landingPageStyles.ctaCard}>
                        ...
                        <div className={landingPageStyles.ctaCardContent}>
                            ...
                            <p className={landingPageStyles.ctaDescription}>Join thousands of professionals who landed their ddream jobs with our platform</p>
        ...
        <footer className={landingPageStyles.footer}>
            <div className={landingPageStyles.footerContainer}>
                <p className={landingPageStyles.footerText}>
                    ...
                    <a href="https://google.com" target='_blank' className={landingPageStyles.footerLink}>Madhav Gera</a>
                </p>
            </div>
        </footer>
